...
void Q5(){
  ...
  cout<<"the total number of even:"<<sum_even<<endl;
  cout<<"how many even number:"<<count_even<<endl;
  cout<<"the total number of odd:"<<sum_odd<<endl;
  cout<<"how many odd number:"<<count_odd<<endl;
}
