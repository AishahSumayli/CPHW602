...
product_graph = ROOT.TGraphErrors()
selection_cuts = np.arange(0, 0.4,0.01)
...
for i in selection_cuts:
    ...
    product_graph.SetPoint(product_graph.GetN(), i, product)
    product_graph.SetPointError(product_graph.GetN()-1, 0, product_error)
efficiency_graph.GetXaxis().SetTitle("Data")
